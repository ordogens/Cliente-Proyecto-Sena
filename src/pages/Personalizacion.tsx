    ...
    <article className="h-[675px] bg-[#f2f9f7] flex">
      ...
      <section className="w-[70%] h-full border-1 border-black flex flex-col items-center gap-5">
        <section className="w-full h-[7%] flex justify-center gap-4 items-center">
          <p className="text-black font-bold cursor-pointer text-sm">Impresión frontal</p>
          <p className="text-black font-bold cursor-pointer text-sm">Impresión trasera</p>
          <p className="text-black font-bold cursor-pointer text-sm">Manga izquierda</p>
          <p className="text-black font-bold cursor-pointer text-sm">Manga derecha</p>
        </section>

        <section className="border-1 border-black w-[90%] h-[80%] rounded-sm">
          {/* ENVIAMOS EL ARCHIVO */}
          <ShirtDesigner file={file} view="front" />
        </section>
