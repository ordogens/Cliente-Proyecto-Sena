  ...
  return (
    <div className="h-171 bg-[#f2f9f7]">
      <h1
        ...
        } text-4xl font-bold pt-6 text-center`}
      >
        ...
        {opciones1.map((img) => (
          <div key={img.id} className="group flex mb-6 justify-center">
            <div
              ...
              className={`flex border-1 border-gray-300 flex-col w-40 h-75 ${
                isDarkMode ? "bg-[#232d4a]" : "bg-[#f1f5f9]"
              } group-hover:transform duration-300 hover:scale-110 rounded-lg cursor-pointer shadow-2xl hover:shadow-2xl`}
            >
              ...
              <p
                className={`font-bold ${
                  isDarkMode ? "text-white" : "text-black"
                } text-center group-hover:text-green-400 break-words mt-3 duration-300`}
              >
                {img.descripcion}
              </p>
            </div>
